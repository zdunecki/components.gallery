  ...
  (
    ...
    return (
      <Box as={as} ref={ref} className={styles.GridItem} {...searchAttributes}>
        <Link legacyBehavior href={url} className={styles.Text} target={isExternal ? '_blank' : undefined}>
          <a onClick={customOnClick} rel={isExternal ? 'noopener noreferrer' : undefined} target={isExternal ? '_blank' : undefined}>
